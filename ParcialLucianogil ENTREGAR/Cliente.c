...
/** \brief da de alta un cliente con todos sus campos
 * \param arrayCliente Cliente* estructura representa cliente
 * \param lenCliente int tamaño maximo de array
 * \return int
 *
 */
...
/** \brief modifica un cliente, permitiendo cambiar su nombre apellido y cuit
 *
 * \param arrayCliente Cliente*
 * \param lenCliente int
 * \param idCliente int id cliente ingresado para buscar que cliente desea modificar
 * \return int
 *
 */
